...
import org.http4k.connect.amazon.dynamodb.grammar.condition.condition
import org.http4k.connect.amazon.dynamodb.grammar.projection.project
import org.http4k.connect.amazon.dynamodb.grammar.update.update
...
class HelpersKtTest {
    ...
    fun `project from an item`() {
        assertThat(
            item.project("#alias, attrList[0], attrMap.attrStr, attrList[1][1], attrMap.attrBool",
