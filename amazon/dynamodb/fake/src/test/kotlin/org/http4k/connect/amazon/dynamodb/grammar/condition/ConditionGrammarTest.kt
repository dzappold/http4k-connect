...
class ConditionGrammarTest {
    ...
    fun `attribute value`() {
        assertThat(
            ConditionGrammar.parse("attr1").eval(ItemWithSubstitutions(Item(attr1 of "123"))),
    ...
    fun `indexed attribute value`() {
        assertThat(
            ConditionGrammar.parse("attrList[1]").eval(
    ...
    fun `deeply indexed attribute value`() {
        assertThat(
            ConditionGrammar.parse("attrList[0][1][2]").eval(
                ItemWithSubstitutions(
                    Item(
                        attrList of listOf(
                            attrList.asValue(
    ...
    fun `nested map attribute value`() {
        assertThat(
            ConditionGrammar.parse("attrMap.attrMap.attr1").eval(
    ...
    fun `map attribute value`() {
        assertThat(
            ConditionGrammar.parse("attrMap.attr1").eval(
    ...
    private fun assert(
        ...
        val dynamoDbGrammar = ConditionGrammar.parse(expression)
        assertThat(
            "$expression\n${item.item}\n${item.values}\n${item.names}",
